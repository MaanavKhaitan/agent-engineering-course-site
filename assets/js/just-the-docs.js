...
function initSearch() {
  ...
  request.open('GET', '/agent-engineering-course-site/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/agent-engineering-course-site/assets/css/just-the-docs-' + theme + '.css');
}
